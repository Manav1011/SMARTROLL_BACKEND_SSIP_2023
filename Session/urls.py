...
from .views import create_lecture_session, mark_attendance_for_student,get_session_data_for_export,mark_attendance_for_absent_student,generate_survey_for_a_lecture,submit_survey,get_survey_details,submit_survey,end_survey
urlpatterns = [     
    ...
    path('get_survey_details/<str:lecture_slug>',get_survey_details,name='get_survey_details'),
