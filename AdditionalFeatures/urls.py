...
from .views import generate_survey_for_a_lecture,get_surveys_of_the_teacher,get_surveys_of_the_student,upload_study_material,get_study_material_for_students,get_study_material_for_teachers
urlpatterns = [     
