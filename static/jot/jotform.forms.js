...
var JotForm = {
        ...
        window.addEventListener("load", function () {
          if (
            ...
            if (typeof window.CardForm !== "undefined") {
              ...
              $$(".form-section:not([id^=section_])").each(function (
                section,
                index
              ) {
                if (section.select(['data-payment="true"'])) {
                  productIndex = index;
                }
              });
              JotForm.jumpToGivenPage(productIndex + 1);
            }
          }
        });
      } catch (err) {
    ...
    setTimeout(function () {
      if (
        !(
          ...
          (JotForm.replaceTagTest && JotForm.isEditMode())
        )
      ) {
        JotForm.runAllConditions();
      }
            ...
            if (
              ...
              try {
                ...
                if (
                  ...
                  !(document.getElementById("draftID") || JotForm.isEditMode())
                ) {
  ...
  checkEmbed: function () {
    ...
    if (window !== window.top) {
      form.insert(
        new Element("input", { type: "hidden", name: "embedUrl" }).putValue(
          document.referrer
        )
      );
      if (JotForm.debug) {
  ...
  jumpToGivenPage: function (page) {
    ...
    if (page === undefined || page > sections.length) return;
